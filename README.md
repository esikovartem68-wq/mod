...
| `weaponforge-1.0.0.jar` | исходник сборки (архив) |
| `мод/ArcanaForge-1.20.1-v1.0.0.jar` | копия общего мода (тот же файл) |
...
Три BB-модели (`bbmodels/magic_wand`, `ghost_knight_hat`, `ancient_golem`)
сконвертированы в игровой формат и
